    ...
    $j(document).ready(function() {
        function getRelated() {
            ...
            for(var i=0; i<tags.length; i++){
                req=$j.getJSON('http://api.tumblr.com/v2/blog/'+document.domain+'/posts?api_key=VspHunyBAE3ZhmnivmJ7F8AMZX84Ptz96XCHGCdCRyg0DLNKif&jsonp=?&limit='+config.num+'&offset=0&type='+config.type+'&tag='+escape(tags[i]), function(data) {
